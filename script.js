function updateDayAndTime() {
    ...
    const dayOfWeek = daysOfWeek[today.getDay()]; // retrieve current day as an index from 'Date' to get current day from 'daysOfWeek'
...
updateDayAndTime(); // call the function once to display current day and UTC time
